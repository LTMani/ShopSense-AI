# ShopSense AI Flask Application Factory and CLI
from pathlib import Path

BASE_APP = Path(__file__).resolve().parent.parent / 'app'
ROOT = Path(__file__).resolve().parent.parent

(BASE_APP / '__init__.py').write_text('''import os
import logging
...
# wsgi.py
(ROOT / 'wsgi.py').write_text('''from app import create_app
...
print('Application entry points written successfully!')
